...
var load_theme = function(){
	...
	if(custom_is_on('retina')) is_retina = '_retina';
	$('.background').css({'background':'url(image/'+$('#theme a[data-type="background"]').attr('data-background') + is_retina + '.png)','background-size':'auto 100%','background-position':background_position});
	$('#hover_block').css({'background':'url(image/'+$('#theme a[data-type="hover_block"]').attr('data-background') + '.'+$('#theme a[data-type="hover_block"]').attr('data-image_type')+')', 'background-size':'cover'});
...
var custom_btn = function(){
	...
	$('.custom_btn').click(function(){
		...
		if($('.custom_btn').children('img').attr('src') == 'image/custom.png'){
			$('.custom_btn').children('img').attr('src','image/exit.png');
			var point = 0;
		}else{
			$('.custom_btn').children('img').attr('src','image/custom.png');
...
$(document).ready(function(e) {
	...
	var hover_block_bg = 'image/'+$('#theme a[data-type="hover_block"]').attr('data-background') + '.'+$('#theme a[data-type="hover_block"]').attr('data-image_type');
	var background = 'image/'+$('#theme a[data-type="background"]').attr('data-background') + '_retina.'+$('#theme a[data-type="background"]').attr('data-image_type');
